...
public class RequestParams {
    ...
    ModelDmtReqParam modelDmtReqParam;
    ...
    public ModelDmtReqParam getModelDmtReqParam() {
        return modelDmtReqParam;
    }

    public void setModelDmtReqParam(ModelDmtReqParam modelDmtReqParam) {
        this.modelDmtReqParam = modelDmtReqParam;
    }
