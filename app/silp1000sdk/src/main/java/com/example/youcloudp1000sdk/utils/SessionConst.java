...
public class SessionConst {
    ...
    public static String getString(Context context, String key) {
        ...
        pref = context.getSharedPreferences(MyConst.sessionName, Context.MODE_APPEND); // 0 - for private
        // mode
    ...
    public static int getInt(Context context, String key) {
        SharedPreferences pref;
        pref = context
                .getSharedPreferences(MyConst.sessionName, Context.MODE_APPEND); // 0 - for private
        // mode
